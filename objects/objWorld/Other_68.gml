	...
	if (port == global.online.tcp) {
		switch (packet) {
			case 0:
				...
				if (!__ONLINE_found) {
					var __ONLINE_oPlayer = instance_create_layer(0, 0, "Controllers", objOnlinePlayer);
			...
			case 4:
				...
				if (__ONLINE_found) {
					...
					var __ONLINE_oChatbox = instance_create_layer(0, 0, "Controllers", objOnlineChatBox);
			...
			case 5:
				...
				if (!global.online.race) {
					...
					var __ONLINE_saved = instance_create_layer(0, 0, "Controllers", objOnlineSaved);
		...
		switch (packet) {
			case 1:
				...
				if (!__ONLINE_found) {
					__ONLINE_oPlayer = instance_create_layer(0, 0, "Controllers", objOnlinePlayer);
					__ONLINE_oPlayer.__ONLINE_ID = __ONLINE_ID;
				}
